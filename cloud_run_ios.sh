...
#   -a APK      path to the .ipa (default BrowserStack-SampleApp.ipa)
...
TAG="baseline"
DEVICE="iPhone 17-26"
FLOW="$ROOT_DIR/SAMPLE_IOS_TEST/ios-benchmark-loop.yaml"
IPA="$ROOT_DIR/apps/BrowserStack-SampleApp.ipa"
SKIP_UPLOAD=0
